...
class EventoView {
	...
	*/
	...
	public function render(){
		...
		$btns = '<div class="canal__programas__programa__btns" style="float:left; width: '.$this->styleBox['childBoxWidth'].'vw; left: '.$this->styleBox['childBoxleft'].'vw"><button class="canal__programas__programa__btns__btnok" data-idprg="'.$this->evt->id.'" data-evttitle="'.$this->evt->title.'" data-evtdatetime="'.$this->evt->begin.'">Ok</button></div>';
